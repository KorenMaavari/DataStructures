...
private:
	...
	RankAVL<int, Team*> teams;
	RankAVL<Team, Team*> prioritizedTeams;
	UnionFind players;
    List<TeamInfo*, int> teamInfoDestructionList;
	List<Team*, int> teamDestructionList;
	List<Player*, int> playerDestructionList;
